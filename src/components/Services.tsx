...
const SERVICES: Service[] = [
  {
    ...
    icon: Compass,
    gradient: 'radial-gradient(ellipse at top left, rgba(245,168,28,0.16) 0%, transparent 65%)',
  },
  {
    ...
    icon: Bot,
    gradient: 'radial-gradient(ellipse at top right, rgba(253,208,82,0.14) 0%, transparent 65%)',
  },
  {
    ...
    icon: Magnet,
    gradient: 'radial-gradient(ellipse at bottom left, rgba(224,138,14,0.16) 0%, transparent 65%)',
  },
  {
    ...
    icon: Workflow,
    gradient: 'radial-gradient(ellipse at bottom right, rgba(245,168,28,0.14) 0%, transparent 65%)',
  },
  {
    ...
    icon: GraduationCap,
    gradient: 'radial-gradient(ellipse at center, rgba(253,208,82,0.13) 0%, transparent 70%)',
  },
]
  ...
  return (
    <section id="services" className="relative bg-ink-900 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        <Reveal>
          <span className="text-[12px] font-medium uppercase tracking-widest text-gold-500">What we do</span>
          <h2 className="mt-3 text-3xl font-medium tracking-tight text-white sm:text-4xl">Services</h2>
        </Reveal>
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 sm:mt-14 md:grid-cols-2 lg:grid-cols-3">
          {SERVICES.map((service, i) => (
            ...
            >
              <div className="group relative h-full overflow-hidden rounded-3xl bg-white/[0.03] p-7 ring-1 ring-white/10 transition-all duration-300 hover:-translate-y-1 hover:ring-gold-500/30 sm:p-8">
                ...
                />
                <span className="relative mb-5 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-gold-500/10 text-gold-400 ring-1 ring-gold-500/20 transition-transform duration-300 group-hover:scale-110">
                  <service.icon className="h-5 w-5" />
                </span>
                <h3 className="relative text-lg font-medium text-gold-400 sm:text-xl">{service.title}</h3>
                <p className="relative mt-2.5 text-[14px] leading-relaxed text-white/55 sm:text-[15px]">
                  {service.description}
                </p>
              </div>
            </Reveal>
