...
export default function About() {
  return (
    <section id="about" className="relative overflow-hidden bg-ink-950 py-24 sm:py-32">
      <div className="pointer-events-none absolute -right-32 top-1/4 h-[360px] w-[360px] rounded-full bg-gold-500/5 blur-[120px]" />
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-5 sm:px-8 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16 lg:px-10">
        <Reveal>
          <div className="flex items-start gap-3 lg:sticky lg:top-28">
            <span className="text-gold-500 opacity-90">
              <Logo markOnly />
            </span>
            <h2 className="text-3xl font-medium tracking-tight text-white sm:text-4xl">About Us</h2>
          </div>
        </Reveal>

        <div className="space-y-6 text-[15px] leading-relaxed text-white/60 sm:text-base lg:text-lg">
          <Reveal delay={80}>
            <p>
              At <span className="text-white">Magni Automations</span>, we believe AI should do more than look
              impressive — it should save time, reduce costs, and create measurable growth.
            </p>
          </Reveal>
          <Reveal delay={160}>
            <p>
